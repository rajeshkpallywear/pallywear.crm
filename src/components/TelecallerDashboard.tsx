  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4">
        <div className="bg-white p-3 sm:p-5 rounded-2xl border border-gray-100 shadow-xs flex flex-row sm:flex-col items-center sm:items-start gap-3 sm:gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <span className="text-[9px] font-medium text-gray-400 hidden sm:block mt-2">Active assigned leads</span>
          </div>
        </div>

        <div className="bg-white p-3 sm:p-5 rounded-2xl border border-gray-100 shadow-xs flex flex-row sm:flex-col items-center sm:items-start gap-3 sm:gap-3">
          <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-red-50 text-red-500 flex items-center justify-center shadow-xs shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Right side: Performance Feed & Leaderboard */}
