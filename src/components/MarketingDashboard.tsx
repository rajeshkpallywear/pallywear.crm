      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <button
          ...
          className={cn(
            ...
            selectedSection === 'recent'
              ? "bg-brand-primary border-brand-primary shadow-2xl shadow-brand-primary/30 scale-[1.02]"
              : "bg-white border-gray-100 shadow-sm hover:border-brand-primary/40 hover:shadow-lg hover:scale-[1.01]"
          )}
        >
          <div className={cn(
            "absolute inset-0 opacity-10 pointer-events-none",
            selectedSection === 'recent' ? "bg-[radial-gradient(circle_at_top_right,white,transparent)]" : ""
          )} />
          <div className={cn(
            "w-12 h-12 rounded-2xl flex items-center justify-center shadow-md transition-colors",
          ...
          <div>
            ...
            <span className={cn("text-[10px] font-medium block mt-2", selectedSection === 'recent' ? "text-white/60" : "text-gray-400")}>
        ...
        >
          ...
          <div>
            ...
            <span className={cn("text-[10px] font-medium block mt-2", selectedSection === 'process' ? "text-white/60" : "text-gray-400")}>
        ...
        >
          <div className={cn(
            "w-12 h-12 rounded-2xl flex items-center justify-center shadow-md transition-colors",
            selectedSection === 'hold' ? "bg-white/20 text-white" : "bg-red-50 text-red-500 group-hover:bg-red-100"
          )}>
            <AlertCircle size={22} />
          </div>
          <div>
            ...
            <span className={cn("text-[10px] font-medium block mt-2", selectedSection === 'hold' ? "text-white/60" : "text-gray-400")}>
        ...
        >
          ...
          <div>
            ...
            <span className={cn("text-[10px] font-medium block mt-2", selectedSection === 'completed' ? "text-white/60" : "text-gray-400")}>
